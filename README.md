...
$(function() {
    ...
    <style class="silex-inline-styles" type="text/css">
        ...
        .silex-id-1490524272632-1 {
            top: 100px;
            left: NaNpx;
        }
        
        .silex-id-1490524272630-0 {
            min-height: 100px;
    ...
    <!-- Silex HEAD tag do not remove -->sdfghjkl
...
<body data-silex-id="body-initial" class="body-initial enable-mobile silex-runtime" data-silex-type="container">
    ...
    <div data-silex-type="container" class="prevent-draggable container-element website-min-width editable-style silex-id-1484660025157-38 section-element bg-grad" data-silex-id="silex-id-1484660025157-38">
        <div data-silex-type="container" class="editable-style silex-element-content website-width silex-id-1484660025157-37 silex-container-content container-element prevent-draggable" data-silex-id="silex-id-1484660025157-37">
            ...
            <div data-silex-type="image" class="editable-style silex-id-1484660587788-48 image-element hide-on-mobile"
                data-silex-id="silex-id-1484660587788-48"><img src="../../../../../../../libs/templates/silex-templates/smart-simple/assets/1484682018_Three_Finger_Swipe_Right.png" class="silex-element-content"></div>
        </div>
    </div>
    ...
    <div data-silex-type="container" class="prevent-draggable container-element website-min-width editable-style silex-id-1490524272632-1 section-element" data-silex-id="silex-id-1490524272632-1">
        <div data-silex-type="container" class="editable-style silex-element-content website-width silex-id-1490524272630-0 silex-container-content container-element prevent-draggable" data-silex-id="silex-id-1490524272630-0"></div>
    </div>
</body>
